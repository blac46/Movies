...
class AllMoviesScrren extends StatefulWidget {
  const AllMoviesScrren({Key? key}) : super(key: key);

  @override
  State<AllMoviesScrren> createState() => _AllMoviesScrrenState();
}

class _AllMoviesScrrenState extends State<AllMoviesScrren> {
